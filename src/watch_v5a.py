# watch_v5a.py — v5-A(마스킹, 물리자유) 및 v5.5. 자동 반복 + 긴 표시.
...
ap.add_argument("--model", default=r"runs\op3_kick_v5_s0.zip")
ap.add_argument("--vecnorm", default=r"runs\vecnorm_v5_s0.pkl")
...
env = OP3KickEnvV5(kick_window=None, max_steps=a.max_steps)   # eval=coast, 마스킹
